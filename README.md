...
一个面向朋友之间在线娱乐的开源麻将 Web 应用。（2-4人即可）

本项目仅用于学习、技术交流和非商业娱乐用途，请勿用于任何违法或商业运营用途。
...
> 目前项目以“朋友之间快速开房娱乐”为目标，规则和计分偏轻量实用，不追求完整地方麻将竞技规则。当前是大众麻将北方麻将（三花+东南西北白发中），后续可以增加根据大家反馈增加川麻、贵麻风格。




![图片说明](docs/images/登陆端.png)

![图片说明](docs/images/对局画面.png)

![图片说明](docs/images/结算界面.png)
...
- 当前版本可作为首个发布版本使用。
- 已知限制：结算页 PNG 长图导出在部分浏览器/环境下可能无法稳定保存，后续第二版本继续优化。
...
- 本项目仅供学习、技术研究与非商业交流使用。
- 本项目与任何商业麻将游戏平台不存在任何关联。
- 请遵守当地法律法规，不得将本项目用于赌博、违法经营或其他非法用途。
